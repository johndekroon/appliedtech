<div class="jumbotron">
		...
		<div class="row">
			<div class="col-md-4">
				<p>
					<h3>Experience Route starten</h3>
					<img src="http://www.fantom-xp.com/wallpapers/23/Puzzle_Windows_7_wallpaper.jpg" height='250' width='250' class="img-responsive" />
					<p>Ervaar de stad vanuit een nieuwe blik.</p>
